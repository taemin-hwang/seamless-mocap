...
from src.models.higherhrnet.models.higherhrnet import HigherHRNet
from src.models.higherhrnet.misc.HeatmapParser import HeatmapParser
from src.models.higherhrnet.misc.utils import (get_multi_scale_size, resize_align_multi_scale, get_multi_stage_outputs, aggregate_results,
                        get_final_preds)
...
class SimpleHigherHRNet:
    ...
    def __init__(self,
        ...
        if not self.enable_tensorrt:
            ...
            from src.models.higherhrnet.misc.tensorrt_utils import TRTModule_HigherHRNet
            self.model = TRTModule_HigherHRNet(path=checkpoint_path, device=torch.device("cuda"))
